...
77. the most important Next.js features to learn (in 8 minutes)
https://www.youtube.com/watch?v=LkDelp5WWYU

78. 🔥 Абсолютно новое мышление с Server Components
https://youtu.be/XjnQLtjFLXM

79. 🔥 Фронтендеры поглощают бэкэнд! Больше никаких эндпоинтов!
https://www.youtube.com/watch?v=As8C_h-OMVM

80. Как сделать Loader / Skeleton для серверных компонентов
https://youtu.be/3-dLp4Ei2uQ

81. Сравниваем первую загрузку SSR и SPA
https://youtu.be/Dj-kBX4gFkU?list=PLz_dGYmQRrr-jmmVN0X-VtlSv1k9aVbEt

82. Куда катится React? Это успех или провал?
https://youtu.be/0nrefXDVAxI

83. Next 14 + React Query COMBO with Server Actions and RSC
https://youtu.be/yVsaCVEfPn4

84. Why I don't use React-Query and tRPC in Next.js
https://youtu.be/51pf_nCJpwg

85. Fetching Data Doesn't Get Better Than This
https://youtu.be/OgVeQVXt7xU

86. Why I Won't Use Next.js
https://www.epicweb.dev/why-i-wont-use-nextjs

87. Как стартовать новый проект в 2023 году?
https://youtu.be/xAuyIEhpKi8

88. The CSS property you didn't know you needed (isolation: isolate)
https://dev.to/francescovetere/the-css-property-you-didnt-know-you-needed-3fk0

89. What The Heck, z-index??
https://www.joshwcomeau.com/css/stacking-contexts/

90. Remix might win the React framework race - thanks to React Router!
https://youtu.be/Ip6LTyIIHgc

91. Remix (now React Router) is the future of React.js
https://youtu.be/C1IXZpyLgjk

92. Операционные системы Light, Александр Маятин, Лекция 0
https://youtu.be/A-LMcrS0p2g?list=PLd7QXkfmSY7aPeSD_OzpK_qVlgxg3X1mC

93. Boneless UI
https://youtu.be/ap1poqjUDNs

94. Headless, boneless, skinless & lifeless UI
https://nerdy.dev/headless-boneless-and-skinless-ui

95. Размер React Router вырос в 3 раза
https://youtu.be/GpKNDnwaJz0